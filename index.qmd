...
::: profile-links
[{{< iconify academicons google-scholar >}} Scholar](https://scholar.google.com/citations?user=pMLEyBAAAAAJ&hl=de&oi=ao){target="_blank"} [{{< iconify academicons orcid >}} ORCID](https://orcid.org/0000-0001-7475-476X){target="_blank"} [{{< iconify simple-icons linkedin >}} LinkedIn](https://linkedin.com/in/alexander-marbler){target="_blank"} <!-- [{{< iconify simple-icons github >}} Github](https://github.com/amarbler){target=_blank} --> [{{< iconify mdi envelope >}} Email](mailto:alexander.marbler@uni-graz.at)
:::
::::::

### News

-   **New Version of Pop-AUT Available:** [Version v2.0 available at Zenodo.](https://doi.org/10.5281/zenodo.10477869) [(11/25)]{.news-date}
-   **Young Economist Award 2025:** Received from the Austrian Economic Association (NOeG) for [When supply chains run dry: Spillovers intensify the economic impact of water scarcity.](https://dx.doi.org/10.2139/ssrn.5354158) [(09/25)]{.news-date}
:::::::
...
[Paper](https://dx.doi.org/10.2139/ssrn.5354158) \| [[Young Economist Award (NOeG 2025)](https://en.noeg.ac.at/awards-fellowships#h.p_XDghNQSumeoD)]{.award}
...
[Paper](https://doi.org/10.1016/j.jeem.2024.102931) \| [Slides](files/EconWAT_slides.pdf) \| [[Young Economist Award (NOeG 2021)](https://en.noeg.ac.at/awards-fellowships#h.p_XDghNQSumeoD)]{.award}
