...
![](marbler.png){.profile-img}

<div class="profile-name">Alexander Marbler</div>

<div class="profile-desc">
  I am a postdoctoral researcher at the [Wegener Center for Climate and Global Change](https://wegcenter.uni-graz.at/en/) at the [University of Graz](https://www.uni-graz.at/en/), working on topics in environmental and spatial economics.
</div>

<div class="profile-links">

[{{< iconify academicons google-scholar >}} Scholar](https://scholar.google.com/citations?user=pMLEyBAAAAAJ&hl=de&oi=ao){target=_blank}
[{{< iconify academicons orcid >}} ORCID](https://orcid.org/0000-0001-7475-476X){target=_blank}
[{{< iconify simple-icons linkedin >}} LinkedIn](https://linkedin.com/in/alexander-marbler){target=_blank}
[{{< iconify simple-icons github >}} Github](https://github.com/amarbler){target=_blank}
[{{< iconify mdi envelope >}} Email](mailto:alexander.marbler@uni-graz.at)
...
### News
- **New working paper available:** [When supply chains run dry: Spillovers intensify the economic impact of water scarcity.](https://dx.doi.org/10.2139/ssrn.5354158)
- **24-09-2025** — [Presentation at NOeG Annual Conference in Krems, Austria.](https://www.donau-uni.ac.at/en/university/faculties/business-globalization/departments/migration-globalization/news-events/events/2025/noeg_conf_25/program.html#op55)
...
***Award:*** [Young Economists Award (NOeG 2021)](https://en.noeg.ac.at/awards-fellowships#h.p_XDghNQSumeoD)
